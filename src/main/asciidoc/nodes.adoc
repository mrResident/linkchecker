=== HTTP запросы для получения информации о вершинах графа
==== Получить список вершин графа.
...
==== HTTP запросы для получения информации о вершине графа.
===== Получить информацию о вершине графа по её идентификатору.
...
===== Получить информацию о вершине графа по её уникальному имени.
...
==== Примеры ошибок при получении данных о вершине(ах) графа
===== Ошибка поиска информации о вершине графа по уникальному имени
*Пример запроса*
...
=== HTTP запросы для создания новой(ых) вершин(ы) в граф
...
==== Примеры ошибок возникающие при создании вершин графа
===== Ошибка валидации при создании вершины графа
